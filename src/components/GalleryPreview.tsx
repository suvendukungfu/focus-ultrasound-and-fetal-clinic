        ...
        <div className="columns-1 md:columns-2 gap-6 md:gap-8 space-y-6 md:space-y-8">
          {images.map((item, index) => (
            <motion.div
              ...
              className={`group relative overflow-hidden rounded-[2rem] border border-white/50 shadow-soft hover:shadow-elevated transition-all duration-700 break-inside-avoid`}
            >
