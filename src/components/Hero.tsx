...
const Hero = () => {
  ...
  return (
    <section ref={containerRef} className="relative min-h-[100dvh] flex flex-col justify-center overflow-hidden pt-20 bg-background/30">
      ...
      <div className="relative z-10 container-narrow mx-auto px-4 py-12 md:py-20 flex-1 flex flex-col justify-center">
        <div className="grid lg:grid-cols-12 gap-8 md:gap-12 items-center">
          
          {/* Content Column - Aggressively narrowed and left-aligned */}
          <div className="lg:col-span-7 xl:col-span-6">
            <MotionReveal delay={0.1} duration={0.8}>
              <BrandLogo size="lg" className="mb-4 md:mb-6" />
            </MotionReveal>
            ...
            <MotionReveal delay={0.6} duration={0.8}>
              <div className="flex flex-col sm:flex-row gap-4 mb-10 md:mb-12">
                <Link
                  to="/contact"
                  className="bg-medical-teal text-white hover:bg-medical-teal/90 px-6 md:px-8 py-3.5 md:py-4 rounded-xl md:rounded-2xl font-semibold shadow-glow flex items-center justify-center gap-2 transform transition-transform hover:-translate-y-1"
                >
