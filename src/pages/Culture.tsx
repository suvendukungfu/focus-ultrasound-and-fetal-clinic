            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {statCards.map((stat, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="relative group p-10 rounded-[2.5rem] bg-card shadow-elevated border border-border text-center flex flex-col items-center justify-center transition-all duration-500 hover:scale-[1.05] hover:shadow-2xl overflow-hidden"
                >
                  ...
                  <div className={`text-4xl md:text-5xl font-black ${stat.color} mb-3 tracking-tighter drop-shadow-sm`}>
                    {stat.value}
                  </div>
