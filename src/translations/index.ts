...
export const translations: Record<Language, { [key: string]: TranslationValue }> = {
  en: {
    ...
    'services.wholeAbdomen.name': 'USG Whole Abdomen (Upper + KUB)',
    'services.wholeAbdomen.desc': 'Detailed evaluation of liver, gallbladder, spleen and urinary system.',
    'services.kub.name': 'KUB / Lower Abdomen (Male Pelvis)',
    'services.kub.desc': 'Specialized scan for Kidney, Ureter, Bladder and male pelvic organs.',
    'services.femalePelvis.name': 'Transabdominal Pelvis (Female)',
    'services.femalePelvis.desc': 'Comprehensive assessment of the uterus and ovaries.',
    'services.tvs.name': 'TVS (Transvaginal Scan)',
    'services.tvs.desc': 'High-resolution internal imaging for detailed gynecological assessment.',
    'services.smallParts.name': 'Small Parts (Thyroid)',
    'services.smallParts.desc': 'High-frequency imaging of the thyroid gland and superficial structures.',
    'services.breast.name': 'USG Bilateral Breast',
    'services.breast.desc': 'Advanced breast tissue screening for early detection.',
    'services.scrotum.name': 'Scrotum / Soft Tissues',
    'services.scrotum.desc': 'High-resolution imaging of scrotal and soft tissue structures.',
    ...
    'services.category.abdominal': 'Abdominal & Pelvic Scans',
    'services.category.smallParts': 'Small Parts & Breast Scans',
    'services.category.obstetric': 'Obstetric Scans',
    'services.category.advanced': 'Advanced Scans',
    'services.routineObs.name': 'Routine Obs (Early Pregnancy)',
    'services.routineObs.desc': 'Early pregnancy confirmation and viability assessment.',
    'services.level1.name': 'Level 1 (NT/NB Scan)',
    'services.level1.desc': 'First-trimester screening for chromosomal markers and early anatomy.',
    ...
    'services.level2.name': 'Level 2 (TIFFA / Anatomy Scan)',
    'services.level2.desc': 'Detailed gold-standard anomaly scan for fetal assessment.',
    'services.fetalEcho.name': 'Fetal Echocardiography',
    'services.fetalEcho.desc': 'Specialized assessment of the fetal heart structure.',
    'services.obsDoppler.name': 'Obs Doppler / Growth Scan / Biophysical Profile',
    'services.obsDoppler.desc': 'Monitoring fetal growth, blood flow, and biophysical profile.',
    ...
    'services.items': [
      ...
      { name: 'Scrotum / Soft Tissues', desc: 'High-resolution imaging of scrotal and soft tissue structures.' },
    ...
    'contact.options.scans': [
      'USG Whole Abdomen (Upper + KUB)',
      'KUB / Lower Abdomen (Male Pelvis)',
      'Transabdominal Pelvis (Female)',
      'TVS (Transvaginal Scan)',
      'Small Parts (Thyroid)',
      'USG Bilateral Breast',
      'Scrotum / Soft Tissues',
      'Routine Obs (Early Pregnancy)',
      'Level 1 (NT/NB Scan)',
      'Level 2 (TIFFA / Anatomy Scan)',
      'Fetal Echocardiography',
      'Obs Doppler / Growth Scan / Biophysical Profile',
      'Fibroscan / Elastography',
      'Cervical Assessment + Uterine Doppler',
      'Other'
    ],
  ...
  hi: {
    ...
    'services.wholeAbdomen.name': 'यूएसजी पूरे पेट (ऊपरी + केयूबी)',
    'services.wholeAbdomen.desc': 'लिवर, पित्त की थैली, तिल्ली और मूत्र प्रणाली का विस्तृत मूल्यांकन।',
    'services.kub.name': 'केयूबी / निचला पेट (पुरुष श्रोणि)',
    'services.kub.desc': 'गुर्दे, मूत्रवाहिनी, मूत्राशय और पुरुष श्रोणि अंगों के लिए विशेष स्कैन।',
    'services.femalePelvis.name': 'ट्रांसएब्डोमिनल पेल्विस (महिला)',
    'services.femalePelvis.desc': 'गर्भाशय और अंडाशय का व्यापक मूल्यांकन।',
    'services.tvs.name': 'टीवीएस (ट्रांसवेजाइनल स्कैन)',
    'services.tvs.desc': 'विस्तृत स्त्री रोग मूल्यांकन के लिए उच्च-रिज़ॉल्यूशन इमेजिंग।',
    'services.smallParts.name': 'स्मॉल पार्ट्स (थायराइड)',
    'services.smallParts.desc': 'थायराइड ग्रंथि और सतही संरचनाओं की इमेजिंग।',
    'services.breast.name': 'यूएसजी द्विपक्षीय स्तन',
    'services.breast.desc': 'प्रारंभिक पहचान के लिए उन्नत स्तन ऊतक स्क्रीनिंग।',
    'services.scrotum.name': 'स्क्रोटम / सॉफ्ट टिश्यू',
    'services.scrotum.desc': 'अंडकोष और कोमल ऊतक संरचनाओं की उच्च-रिज़ॉल्यूशन इमेजिंग।',
    'services.fibroscan.name': 'फाइब्रोस्कैन / इलास्टोग्राफी',
    'services.fibroscan.desc': 'लिवर की कठोरता और फैटी परिवर्तनों का मूल्यांकन।',
    'services.category.abdominal': 'पेट और श्रोणि स्कैन',
    'services.category.smallParts': 'स्मॉल पार्ट्स और स्तन स्कैन',
    'services.category.obstetric': 'प्रसूति स्कैन',
    'services.category.advanced': 'उन्नत स्कैन',
    'services.routineObs.name': 'रूटीन ओब्स (प्रारंभिक गर्भावस्था)',
    'services.routineObs.desc': 'प्रारंभिक गर्भावस्था की पुष्टि और व्यवहार्यता मूल्यांकन।',
    'services.level1.name': 'लेवल 1 (NT/NB स्कैन)',
    'services.level1.desc': 'पहली तिमाही की स्क्रीनिंग और प्रारंभिक शरीर रचना विज्ञान।',
    'services.level2.name': 'लेवल 2 (TIFFA / एनाटॉमी स्कैन)',
    'services.level2.desc': 'विस्तृत भ्रूण मूल्यांकन के लिए गोल्ड-स्टैंडर्ड विसंगति स्कैन।',
    'services.fetalEcho.name': 'फीटल इकोकार्डियोग्राफी',
    'services.fetalEcho.desc': 'भ्रूण के हृदय की संरचना का विशेष मूल्यांकन।',
    'services.obsDoppler.name': 'ओब्स डॉपलर / ग्रोथ स्कैन / बायोफिजिकल प्रोफाइल',
    'services.obsDoppler.desc': 'भ्रूण की वृद्धि, रक्त प्रवाह और बायोफिजिकल प्रोफाइल की निगरानी।',
    ...
    'contact.options.scans': [
      'यूएसजी पूरे पेट (ऊपरी + केयूबी)',
      'केयूबी / निचला पेट (पुरुष श्रोणि)',
      'ट्रांसएब्डोमिनल पेल्विस (महिला)',
      'टीवीएस (ट्रांसवेजाइनल स्कैन)',
      'स्मॉल पार्ट्स (थायराइड)',
      'यूएसजी द्विपक्षीय स्तन',
      'स्क्रोटम / सॉफ्ट टिश्यू',
      'रूटीन ओब्स (प्रारंभिक गर्भावस्था)',
      'लेवल 1 (NT/NB स्कैन)',
      'लेवल 2 (TIFFA / एनाटॉमी स्कैन)',
      'फीटल इकोकार्डियोग्राफी',
      'ओब्स डॉपलर / ग्रोथ स्कैन / बायोफिजिकल प्रोफाइल',
      'फाइब्रोस्कैन / इलास्टोग्राफी',
      'सर्वाइकल मूल्यांकन + गर्भाशय डॉपलर',
      'अन्य'
    ],
    'contact.options.doctors': [
      'डॉ. समर सूर्य निरवाल',
